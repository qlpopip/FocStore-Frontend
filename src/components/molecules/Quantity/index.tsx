...
const QuantityComp: React.FC<QuantityProps> = (props) => {
  ...
  return (
    <div className="quantity_box round-16">
      <div onClick={DecrementProduct} className={`quality_icon ${className}`}>
        <Image src={IconsFile.Minus} />
      </div>
      <p>
        {" "}
        {count < 10 && 0}
      ...
      <div onClick={IncrementProduct} className="quality_icon">
        <Image src={IconsFile.Plus} />
      </div>
    </div>
  );
};
