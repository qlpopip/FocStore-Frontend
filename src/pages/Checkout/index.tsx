...
const Checkout: React.FC = () => {
  ...
  const handleComplete = (data: any) => {
    ...
    setInfo({
      ...info,
      zip_code: Number(zonecode),
      address: roadAddress + " " + extraRoadAddress,
    });
                  ...
                  <div className="left_side">
                    ...
                    <div className="payment_box">
                      ...
                      <div className="token_box">
                        <div
                          className="token"
                          onClick={() => onChangeToken("sort", "FOC")}
                        >
                        ...
                        <div
                          className="token"
                          onClick={() => onChangeToken("sort", "USDT")}
                        >
                          <div className="img_box">
                            <Image
                              src={ImagesFile.Tether}
                        ...
                        <div
                          className="token"
                          onClick={() => onChangeToken("sort", "ETH")}
                        >
                          <div className="img_box">
                            <Image
                              src={ImagesFile.Ethereum}
                              className="coin_image"
                            />
                          </div>
                          <InputChoose
