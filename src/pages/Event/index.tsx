...
import { Navigator, Loader, EventSaidBar } from "components/molecules";
          ...
          <EventSaidBar>
            {pending ? (
              ...
              <div className="events_box">
                {eventList.map((item) => {
                  const hasEvent = hasEventList.some(
                    (hasEventItem) => hasEventItem.event.id === item.id
                  );
                  return (
                    <div
                      className="event"
                    ...
                    >
                      ...
                      <div className="event_main">
                        ...
                        <div className="btn_box">
                          ...
                          <Button
                            className={`primary ${hasEvent && "disabled"}`}
                            onClick={() => {
                              showIndexEvent(item.id);
                            }}
                          >
                            Get Point{" "}
                          </Button>
