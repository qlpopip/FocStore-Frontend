    ...
    <Layout id="shopping_cart">
      ...
      {orders.length > 0 ?
        <div className="shopping_container ">
          <div className="shopping_cart round-3">
            <p className="title"> Shopping Cart</p>
            <div className="table_header">
              <div className="products th"><p>PRODUCTS</p></div>
              <div className="price th"><p>PRICE</p></div>
              <div className="quantity th"><p>QUANTITY</p></div>
              <div className="sub_total th"><p>SUB-TOTAL</p></div>
            </div>
            {orders.length > 0 && orders.map((item) => (

              <div className="table_body" key={item.product.id}>
                <div className="remove">
                  <Image src={IconsFile.Remove} alt="" onClick={() => { removeProduct(item.product.id) }} />
                </div>
                <div className="img">
                ...
                <div className="sub_total"><p>${item.product.productPrice * item.productCount}</p></div>
              </div>
            ))}
